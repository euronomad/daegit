...
--parameters publicip_name=mongodkIP01 \
--parameters dnsPrefix=mongodk01 \
--parameters nic_name=mongodkNic01
...
--parameters dataDisk_name=mongodbDataDisk11
az group deployment create --name createDataDisk --resource-group daekimMongoDBRG01 --template-file 01.dataDisk.json \
--parameters dataDisk_name=mongodbDataDisk12

# data disk attach
az vm disk attach --vm-name mongoTestVM01 --disk mongodbDataDisk11 --lun 0 --resource-group daekimMongoDBRG01
az vm disk attach --vm-name mongoTestVM01 --disk mongodbDataDisk12 --lun 1 --resource-group daekimMongoDBRG01
